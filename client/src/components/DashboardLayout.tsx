      ...
      <SidebarInset>
        ...
        <footer className={`border-t border-border/30 px-4 py-4 ${isMobile ? "mb-16" : ""}`}>
          <div className="flex flex-col items-center gap-2">
            <span className="text-[10px] font-semibold text-muted-foreground/70 uppercase tracking-widest">Aboood.ai Network</span>
            <div className="flex flex-wrap items-center justify-center gap-3">
              <a href="https://whatsapp-group.aboood.ai" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-[11px] text-muted-foreground hover:text-emerald-400 transition-colors" title="WhatsApp Group">
